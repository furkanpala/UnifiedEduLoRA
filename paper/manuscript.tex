...
federation of four collaborating institutions
across four countries on three continents
...
\begin{enumerate}[leftmargin=2em, itemsep=2pt]
  ...
  federation of four institutions spanning Tunisia,
  Germany, Nigeria, and Colombia, comparing
...
runs the same framework across four real
collaborating institutions in Tunisia, Germany,
Nigeria, and Colombia training on their own private
curricula, with the sample-size, vocabulary,
...
\textbf{four real collaborating institutions}
spanning four countries on three continents
(Tunisia, Germany, Nigeria, and Colombia), each
contributing its own private machine-learning
...
(NVIDIA RTX~3090/4090), and two on entry-level GPUs
(NVIDIA T4 / RTX~2080~Ti) via a Google Colab free
tier and personal hardware. Second, declared
...
language coverage (one English-only collaborator,
three bilingual), academic level (mixed,
undergraduate-advanced, mixed,
undergraduate-advanced), and privacy posture (one
...
materials with full authorization). Each
...
$\mathcal{I}_0$--$\mathcal{I}_3$. ``Privacy''
...
\red{TODO: private testbed (4 institutions) not yet collected; cells stay as "--" until Phase~2 of the private collaboration finishes. Methods rows (FedKD/MD/DF/ET) are also TODO; those baselines have not been run yet on the public testbed either.}
\begin{table*}[t]
\centering
\small
\caption{Equity comparison on the \textbf{private
testbed} (\S\ref{sec:private_testbed}). Four
...
\multirow{6}{*}{$\mathcal{I}_3$ / Pegasus-X-base}
  ...
  & \UniEdu{}      & -- & -- & -- & -- & -- & -- & -- & -- \\
\midrule
\multirow{6}{*}{Mean across $\mathcal{I}_{0..3}$}
  & Indiv          & -- & -- & -- & -- & -- & -- & -- & -- \\
  & FedKD          & -- & -- & -- & -- & -- & -- & -- & -- \\
  & FedMD          & -- & -- & -- & -- & -- & -- & -- & -- \\
  & FedDF          & -- & -- & -- & -- & -- & -- & -- & -- \\
...
\begin{itemize}[leftmargin=1.5em, itemsep=2pt]
  ...
  testbed and four in the private testbed. Larger
...
\red{TODO: institutional / compute / funding acknowledgments; thanks to the public-testbed source materials (MIT 18.657, Stanford CS229, arXiv) and the four collaborating institutions of the private testbed for their participation; etc.}
