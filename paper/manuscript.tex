...
\red{TODO: single-LLM zero-shot panel (GPT-4o, GPT-4o-mini, Llama-3.1-8B-Inst, Qwen-2.5-7B-Inst, Mistral-7B-Inst, Gemini-1.5-Flash) not yet collected; UniEdu federated-mixture row also pending the OpenAI-enabled re-run.}
\begin{table*}[t]
\centering
\footnotesize
\setlength{\tabcolsep}{3pt}
...
public testbed. Column abbreviations match
