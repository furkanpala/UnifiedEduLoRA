...
\red{TODO: institutional names (or anonymous IDs $\mathcal{I}_0,\dots,\mathcal{I}_4$); recruitment-form demographic figure; per-institution chunk and QA-pair counts; topic-coverage histograms.}
...
institutions, six methods per institution: the
per-institution local baseline \textbf{Indiv}
(\S\ref{sec:baselines}), four heterogeneous-FL
...
\red{TODO: KTI requires per-direction held-out eval on T\_{k\setminus l} chunks; eval pool not yet curated.}
\begin{table}[t]
\centering
\small
